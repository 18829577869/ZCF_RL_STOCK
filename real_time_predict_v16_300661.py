"""
V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（圣邦股份300661专用）
...
# 基础配置
MODEL_PATH = "ppo_stock_v7_300661.zip"  # V11圣邦股份专用模型
STOCK_CODE = 'sz.300661'  # 股票代码（圣邦股份）
...
print("\n" + "=" * 70)
print("V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（圣邦股份300661专用）")
print("=" * 70)
print("整合功能:")
...
if ppo_model and PPO_AVAILABLE:
    try:
        ...
        # 优先使用V11专用目录
        test_data_dir = f'stockdata_v7_300661/test'
