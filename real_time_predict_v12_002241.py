"""
V12 实时预测系统 - Transformer优化版（歌尔股份002241专用）
...
print("\n" + "=" * 70)
print("V12 实时预测系统 - Transformer优化版（歌尔股份002241专用版）")
print("=" * 70)
print("📌 整合功能:")
...
if PPO_AVAILABLE:
    try:
        ...
        possible_models = [
            "ppo_stock_v7_002241.zip",  # 002241专用模型（优先）
            "models_v7_002241/best/best_model.zip",  # 002241最佳模型（优先）
        ...
        if loaded_model_path:
            ...
            if "002241" in MODEL_PATH:
                print(f"✅ PPO模型加载成功: {MODEL_PATH} (歌尔股份002241专用模型)")
            else:
