...
# 模型路径
MODEL_PATH = "ppo_stock_v7_000425.zip"
...
# 排序：徐工机械优先
test_files_sorted = []
if xugong_jixie_test:
    test_files_sorted.append(xugong_jixie_test)
    for test_file in test_files:
