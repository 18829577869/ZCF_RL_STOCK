"""
V12 实时预测系统 - Transformer优化版（漱玉平民301017专用）
...
STOCK_CODE = 'sz.301017'  # 股票代码（漱玉平民）
...
print("\n" + "=" * 70)
print("V12 实时预测系统 - Transformer优化版（漱玉平民301017专用版）")
print("=" * 70)
print("📌 整合功能:")
...
if PPO_AVAILABLE:
    try:
        ...
        possible_models = [
            "ppo_stock_v7_301017.zip",  # 301017专用模型（优先）
            "models_v7_301017/best/best_model.zip",  # 301017最佳模型（优先）
        ...
        if loaded_model_path:
            ...
            if "301017" in MODEL_PATH:
                print(f"✅ PPO模型加载成功: {MODEL_PATH} (漱玉平民301017专用模型)")
            else:
