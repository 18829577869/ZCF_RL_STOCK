"""
V12 实时预测系统 - Transformer优化版（顶固集创300749专用）
...
STOCK_CODE = 'sz.300749'  # 股票代码（顶固集创）
...
print("\n" + "=" * 70)
print("V12 实时预测系统 - Transformer优化版（顶固集创300749专用版）")
print("=" * 70)
print("📌 整合功能:")
...
if PPO_AVAILABLE:
    try:
        ...
        possible_models = [
            "ppo_stock_v7_300749.zip",  # 300749专用模型（优先）
            "models_v7_300749/best/best_model.zip",  # 300749最佳模型（优先）
        ...
        if loaded_model_path:
            ...
            if "300749" in MODEL_PATH:
                print(f"✅ PPO模型加载成功: {MODEL_PATH} (顶固集创300749专用模型)")
            else:
