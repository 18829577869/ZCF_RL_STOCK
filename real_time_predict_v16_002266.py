"""
V16 实时预测系统 - DeepSeek 轮次复盘增强版（浙富控股002266专用）
...
专用标的：浙富控股002266（核电设备板块）
模型来源：使用国机重装601399的模型进行预测
"""
...
# 基础配置
MODEL_PATH = "ppo_stock_v7_601399.zip"  # 使用国机重装601399的模型
STOCK_CODE = 'sz.002266'  # 股票代码（浙富控股）
...
print("\n" + "=" * 70)
print("V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（浙富控股002266专用）")
print("=" * 70)
print("📌 整合功能:")
