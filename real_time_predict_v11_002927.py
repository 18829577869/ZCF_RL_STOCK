"""
V11 实时预测系统 - 全功能集成版（泰永长征002927专用）
整合 V7、V9、V10 的所有功能：
...
# 基础配置
MODEL_PATH = "ppo_stock_v7_002927.zip"  # 使用泰永长征002927专用模型
STOCK_CODE = 'sz.002927'  # 股票代码（泰永长征）
...
if PPO_AVAILABLE:
    try:
        if not os.path.exists(MODEL_PATH):
            possible_models = [
                "ppo_stock_v7_002927.zip",  # 002927专用模型（优先）
