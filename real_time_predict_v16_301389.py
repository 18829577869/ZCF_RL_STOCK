"""
V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（隆扬电子301389专用）
...
# 基础配置
MODEL_PATH = "ppo_stock_v7_301389.zip"  # V11隆扬电子专用模型
STOCK_CODE = 'sz.301389'  # 股票代码（隆扬电子）
...
CANDIDATE_MODELS = [  # 候选模型列表（按优先级排序）
    {
        'name': '002706模型（最佳）',
        'paths': [
            'ppo_stock_v7_002706.zip',
            'models_v7_002706/best/best_model.zip'
        ],
        'description': '良信股份002706模型（最佳匹配）'
    },
    {
        'name': '通用模型',
        'paths': [
...
print("\n" + "=" * 70)
print("V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（隆扬电子301389专用）")
print("=" * 70)
print("整合功能:")
...
if ppo_model and PPO_AVAILABLE:
    try:
        ...
        # 优先使用V11专用目录
        test_data_dir = f'stockdata_v7_301389_600110/test'
