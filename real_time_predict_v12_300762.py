"""
V12 实时预测系统 - Transformer优化版（上海瀚讯300762专用）
...
STOCK_CODE = 'sz.300762'  # 股票代码（上海瀚讯）
...
print("\n" + "=" * 70)
print("V12 实时预测系统 - Transformer优化版（上海瀚讯300762专用版）")
print("=" * 70)
print("📌 整合功能:")
...
if PPO_AVAILABLE:
    try:
        ...
        possible_models = [
            "ppo_stock_v7_300762.zip",  # 300762专用模型（优先）
            "models_v7_300762/best/best_model.zip",  # 300762最佳模型（优先）
        ...
        if loaded_model_path:
            ...
            if "300762" in MODEL_PATH:
                print(f"✅ PPO模型加载成功: {MODEL_PATH} (上海瀚讯300762专用模型)")
            else:
