...
# 模型路径
MODEL_PATH = "ppo_stock_v7_000547.zip"
...
# 排序：航天发展优先
test_files_sorted = []
if hangtian_fazhan_test:
    test_files_sorted.append(hangtian_fazhan_test)
    for test_file in test_files:
