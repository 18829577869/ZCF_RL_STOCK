...
if PPO_AVAILABLE:
    try:
        ...
        possible_models = [
            "ppo_stock_v7_300726.zip",  # 300726专用模型（优先，用于603267）
            "models_v7_300726/best/best_model.zip",  # 300726最佳模型（优先，用于603267）
        ...
        if loaded_model_path:
            ...
            if "300726" in MODEL_PATH:
                print(f"✅ PPO模型加载成功: {MODEL_PATH} (使用宏达电子300726模型运行鸿远电子603267)")
            else:
