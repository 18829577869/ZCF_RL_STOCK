"""
V12 实时预测系统 - Transformer优化版（鸿远电子603267专用）
...
print("\n" + "=" * 70)
print("V12 实时预测系统 - Transformer优化版（鸿远电子603267专用版）")
print("=" * 70)
print("📌 整合功能:")
...
if PPO_AVAILABLE:
    try:
        ...
        possible_models = [
            "ppo_stock_v7_603267.zip",  # 603267专用模型（优先）
            "models_v7_603267/best/best_model.zip",  # 603267最佳模型（优先）
        ...
        if loaded_model_path:
            ...
            if "603267" in MODEL_PATH:
                print(f"✅ PPO模型加载成功: {MODEL_PATH} (中宠股份603267专用模型)")
            else:
