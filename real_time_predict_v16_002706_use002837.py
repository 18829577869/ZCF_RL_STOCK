"""
V16 实时预测系统 - DeepSeek 轮次复盘增强版（良信股份002706专用，使用英维克002837模型）
...
CANDIDATE_MODELS = [  # 候选模型列表（按优先级排序）
    ...
    {
        'name': '002706模型（使用002837）',
        'paths': [
            'ppo_stock_v7_002837.zip',  # 英维克002837模型（优先，用于良信股份002706）
            'models_v7_002837/best/best_model.zip',  # 英维克002837最佳模型
            'ppo_stock_v7_002706.zip',  # 002706专用模型（备用）
            'models_v7_002706/best/best_model.zip'
        ],
        'description': '良信股份002706模型（使用英维克002837模型）'
    },
    {
        'name': '002025模型',
        'paths': [
...
print("\n" + "=" * 70)
print("V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（良信股份002706专用，使用英维克002837模型）")
print("=" * 70)
print("📌 整合功能:")
