...
# 基础配置
MODEL_PATH = "ppo_stock_v7_300726.zip"  # V12使用通用PPO模型，也可以使用专用模型
...
print("\n" + "=" * 70)
print("V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（立讯精密002475专用）")
print("=" * 70)
print("📌 整合功能:")
