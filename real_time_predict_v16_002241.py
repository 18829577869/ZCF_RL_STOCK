...
# 基础配置
MODEL_PATH = "ppo_stock_v7_603267.zip"  # V12使用通用PPO模型，也可以使用专用模型
...
if ppo_model and PPO_AVAILABLE:
    try:
        ...
        # 根据股票代码查找对应的测试数据文件
        stock_code_num = STOCK_CODE.split('.')[-1]  # 提取股票代码数字部分，如002241
