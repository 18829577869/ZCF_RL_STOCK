...
# 模型路径
MODEL_PATH = "ppo_stock_v7_002413.zip"
...
# 排序：雷科防务优先
test_files_sorted = []
if leike_fangwu_test:
    test_files_sorted.append(leike_fangwu_test)
    for test_file in test_files:
