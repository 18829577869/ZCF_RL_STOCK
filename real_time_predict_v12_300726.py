"""
V12 实时预测系统 - Transformer优化版（宏达电子300726专用）
...
STOCK_CODE = 'sz.300726'  # 股票代码（宏达电子）
...
print("\n" + "=" * 70)
print("V12 实时预测系统 - Transformer优化版（宏达电子300726专用版）")
print("=" * 70)
print("📌 整合功能:")
...
if PPO_AVAILABLE:
    try:
        ...
        possible_models = [
            "ppo_stock_v7_300726.zip",  # 300726专用模型（优先）
            "models_v7_300726/best/best_model.zip",  # 300726最佳模型（优先）
        ...
        if loaded_model_path:
            ...
            if "300726" in MODEL_PATH:
                print(f"✅ PPO模型加载成功: {MODEL_PATH} (卓胜微300726专用模型)")
            else:
