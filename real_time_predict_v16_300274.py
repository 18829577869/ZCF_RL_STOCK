"""
V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（阳光电源300274专用））
...
def get_stock_name(code):
    ...
    stock_name_map = {
        ...
        'sz.300153': '科泰电源',
        'sz.002927': '泰永长征',
        'sz.001208': '华菱线缆',        'sz.300274': '阳光电源',        'sz.002851': '麦格米特',
        'sz.002266': '浙富控股',
...
# 基础配置
MODEL_PATH = "ppo_stock_v7_002927.zip"  # V12使用通用PPO模型，也可以使用专用模型
# 支持通过环境变量或命令行参数指定股票代码
STOCK_CODE = os.getenv('STOCK_CODE', 'sz.300274')  # 股票代码（阳光电源）
...
CANDIDATE_MODELS = [  # 候选模型列表（按优先级排序）
    {
        'name': '002927模型（最佳）',
        'paths': [
            'ppo_stock_v7_002927.zip',
            'models_v7_002927/best/best_model.zip'
        ],
        'description': '泰永长征002927模型（最佳匹配）'
    },
    {
        'name': '通用模型',
        'paths': [
...
print("\n" + "=" * 70)
print("V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（阳光电源300274专用））")
print("=" * 70)
print("📌 整合功能:")
