"""
V12 实时预测系统 - Transformer优化版（航天电器002025专用）
...
STOCK_CODE = 'sz.002025'  # 股票代码（航天电器）
...
print("\n" + "=" * 70)
print("V12 实时预测系统 - Transformer优化版（航天电器002025专用版）")
print("=" * 70)
print("📌 整合功能:")
...
if PPO_AVAILABLE:
    try:
        ...
        possible_models = [
            "ppo_stock_v7_002025.zip",  # 002025专用模型（优先）
            "models_v7_002025/best/best_model.zip",  # 002025最佳模型（优先）
        ...
        if loaded_model_path:
            ...
            if "002025" in MODEL_PATH:
                print(f"✅ PPO模型加载成功: {MODEL_PATH} (航天电器002025专用模型)")
            else:
