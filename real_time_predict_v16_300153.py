...
CANDIDATE_MODELS = [  # 候选模型列表（按优先级排序）
    ...
    {
        'name': '300153模型（使用300499）',
        'paths': [
            'ppo_stock_v7_300499.zip',  # 高澜股份300499模型（优先，用于科泰电源300153）
            'models_v7_300499/best/best_model.zip',  # 高澜股份300499最佳模型
            'ppo_stock_v7_300153.zip',  # 300153专用模型（备用）
            'models_v7_300153/best/best_model.zip'
        ],
        'description': '科泰电源300153模型（使用高澜股份300499模型）'
    },
    {
        'name': '002025模型',
        'paths': [
