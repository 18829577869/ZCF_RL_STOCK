"""
V16 实时预测系统 - DeepSeek 轮次复盘增强版（科泰电源300153专用，使用高澜股份300499模型）
...
专用标的：科泰电源300153（数据中心备用电源板块）
模型来源：使用高澜股份300499的模型进行预测
"""
...
# 基础配置
MODEL_PATH = "ppo_stock_v7_002706.zip"  # V12使用通用PPO模型，也可以使用专用模型
# 支持通过环境变量或命令行参数指定股票代码
STOCK_CODE = os.getenv('STOCK_CODE', 'sz.300153')  # 股票代码（默认：科泰电源300153）
...
print("\n" + "=" * 70)
print("V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（科泰电源300153专用，使用高澜股份300499模型）")
print("=" * 70)
print("整合功能:")
