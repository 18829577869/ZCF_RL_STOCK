"""
V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（隆基绿能601012专用）
...
# 基础配置
MODEL_PATH = "ppo_stock_v7_601012.zip"  # V11隆基绿能专用模型
STOCK_CODE = 'sh.601012'  # 股票代码（隆基绿能）
...
print("\n" + "=" * 70)
print("V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（隆基绿能601012专用）")
print("=" * 70)
print("整合功能:")
...
if ppo_model and PPO_AVAILABLE:
    try:
        ...
        # 优先使用V11专用目录
        test_data_dir = f'stockdata_v7_601012/test'
