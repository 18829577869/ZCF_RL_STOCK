"""
V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（铂科新材300811专用）
...
# 基础配置
MODEL_PATH = "ppo_stock_v7_300811.zip"  # V11铂科新材专用模型
STOCK_CODE = 'sz.300811'  # 股票代码（铂科新材）
...
print("\n" + "=" * 70)
print("V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（铂科新材300811专用）")
print("=" * 70)
print("整合功能:")
...
if ppo_model and PPO_AVAILABLE:
    try:
        ...
        # 优先使用V11专用目录
        test_data_dir = f'stockdata_v7_300811/test'
