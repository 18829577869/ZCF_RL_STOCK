...
STOCK_CODE = os.getenv('STOCK_CODE', 'sh.603698')  # 股票代码（默认：航天工程603698）
...
CANDIDATE_MODELS = [  # 候选模型列表（按优先级排序）
    ...
    },
    {
        'name': '603698模型',
        'paths': [
            'ppo_stock_v7_603698.zip',
            'models_v7_603698/best/best_model.zip'
        ],
        'description': '航天工程603698模型'
    },
    {
        'name': '002025模型',
        'paths': [
...
print("\n" + "=" * 70)
print("V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（航天工程603698专用）")
print("=" * 70)
print("📌 整合功能:")
