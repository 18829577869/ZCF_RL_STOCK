"""
V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（科华数据002335专用）
整合 V7、V9、V10、V11、V12、V13、V14、V15 的所有功能：
...
V16新增功能：
- 趋势/震荡双策略：趋势突破跟随 + 布林带均值回归，与模型信号加权融合

设计理念：多模型协同工作，智能融合决策，自动选择最优模型，风险控制优先，科学资金管理，丰富数据源
专用标的：科华数据002335（数据中心/电力设备）
"""
...
# 基础配置
MODEL_PATH = "ppo_stock_v7_002335.zip"  # V16使用科华数据002335专用PPO模型
STOCK_CODE = 'sz.002335'  # 股票代码（科华数据）
...
CANDIDATE_MODELS = [  # 候选模型列表（按优先级排序）
    {
        'name': '002335模型（专用）',
        'paths': [
            'ppo_stock_v7_002335.zip',
            'models_v7_002335/best/best_model.zip'
        ],
        'description': '科华数据002335专用模型（最佳匹配）'
    },
    {
        'name': '通用模型',
        'paths': [
...
print("\n" + "=" * 70)
print("V16 实时预测系统 - 趋势/震荡双策略 + DeepSeek复盘 + StockAPI（科华数据002335专用）")
print("=" * 70)
print("整合功能:")
